...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Failed first test, expected result: bob  Actual: sue  The stack wasn't in the correct order
    ...
    // Defect(s) Found: Stack is out of order from expected results
